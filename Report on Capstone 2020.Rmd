...
```{r, echo=F, message=F, fig.width=5, fig.align='center'}
# price vs. quantity
# Pearson correlation
...
$P(L) = P(Y \leq 80) = P(T_{1} \geq \frac{121.8 - 80}{29.53})$ = `r p.L.A`
...
$P(L) = P(A,L) + P(B,L)$\ 
$= P(A)P(L|A) + P(B)P(L|B)$\
$= \frac{1}{2}P(T_{1} \geq \frac{121.8 - 80}{29.53}) + \frac{1}{2}P(T_{2} \geq \frac{135.8 - Y}{29.48})$\
$=$ `r pL`
...
$P(B|L) = \frac{P(B)P(L|B)}{P(L)}$ = `r p.B.L` \
